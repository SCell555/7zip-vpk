...
#define IMP_IInArchive_GetProp(k) \
  (UInt32 index, BSTR *name, PROPID *propID, VARTYPE *varType) MY_NO_THROW_DECL_ONLY \
    { if (index >= ARRAYSIZE(k)) return E_INVALIDARG; \
...
#define IMP_IInArchive_Props \
  STDMETHODIMP CHandler::GetNumberOfProperties(UInt32 *numProps) MY_NO_THROW_DECL_ONLY \
    { *numProps = ARRAYSIZE(kProps); return S_OK; } \
...
#define IMP_IInArchive_ArcProps \
  STDMETHODIMP CHandler::GetNumberOfArchiveProperties(UInt32 *numProps) MY_NO_THROW_DECL_ONLY \
    { *numProps = ARRAYSIZE(kArcProps); return S_OK; } \
...
#define IMP_IInArchive_ArcProps_NO_Table \
  ...
  STDMETHODIMP CHandler::GetArchivePropertyInfo(UInt32, BSTR *, PROPID *, VARTYPE *) MY_NO_THROW_DECL_ONLY \
    { return E_NOTIMPL; } \

#define IMP_IInArchive_ArcProps_NO \
  IMP_IInArchive_ArcProps_NO_Table \
  STDMETHODIMP CHandler::GetArchiveProperty(PROPID, PROPVARIANT *value) MY_NO_THROW_DECL_ONLY \
